...
export const Comparison = () => {
  const [showZeroBoiler, setShowZeroBoiler] = useState(true);
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Stop wasting time deleting demo code. Start with what you actually
            need.
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            <span
              className={
                !showZeroBoiler ? "text-foreground" : "text-muted-foreground"
              }
            >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div
            className={`transition-all duration-500 ${
              showZeroBoiler ? "opacity-30 scale-95" : "opacity-100 scale-100"
            }`}
          >
            <div className="card p-6 border-destructive/20">
              ...
              <div className="space-y-2">
                {traditionalFiles.map((file, index) => (
                  ...
                  >
                    ...
                    <Badge
                      variant={getBadgeVariant(file.type)}
                      className="text-xs"
                    >
                      {file.type}
                    </Badge>
              ...
              <div className="mt-4 p-3 bg-destructive/10 rounded border border-destructive/20">
                <p className="text-sm text-destructive">
                  <X className="inline h-4 w-4 mr-1" />7 files to delete before
                  coding
                </p>
              </div>
            </div>
