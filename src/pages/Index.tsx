        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              Start with zero boilerplate.
            </h1>

            <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
              Zero-Boiler creates clean React and Next.js projects without the clutter. 
              ...
              <div className="flex items-center gap-2">
                ...
                {frameworks.map((framework, index) => (
                  <span key={index} className="badge-framework">
                    {framework.name} <span className="text-muted-foreground">({framework.desc})</span>
                  </span>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-12">
              {options.map((option, index) => (
                <Badge key={index} variant="outline" className="border-border/50 hover:border-primary/30 transition-colors">
                  {option}
                </Badge>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" size="lg" className="border-border hover:border-primary/30 hover:bg-primary/5">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-12">
            Stop wasting time on boilerplate cleanup. Start building what matters.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" className="border-border hover:border-accent/30 hover:bg-accent/5">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-muted-foreground">
              ...
              <a href="#" className="hover:text-primary transition-colors">npm</a>
